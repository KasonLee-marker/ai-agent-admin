...
import com.aiagent.admin.service.impl.PromptServiceImpl;
...
class PromptServiceImplTest {
    ...
    void getPromptVersions_Success() {
        ...
        when(promptMapper.toVersionResponseList(anyList()))
                .thenReturn(Collections.singletonList(new PromptVersionResponse()));
